...
const exercises: Record<string, Exercise[]> = {
  ...
  le6: [
    { prompt: "’n 3-stadium-pyplyn gebruik GH (gaan haal), DE (dekodeer) en UV (uitvoer). I1 begin in siklus 1. In watter stadium begin I2 in siklus 2? Skryf slegs GH, DE of UV.", answer: "gh", explanation: "I1 skuif in siklus 2 na DE; ’n nuwe instruksie, I2, begin dus in GH. ’n Pyplyn begin ’n nuwe instruksie elke siklus in die gaan-haal-stadium.", hint: "I1 is reeds in DE. Watter stadium is altyd die beginpunt vir ’n nuwe instruksie?" },
    { prompt: "In die vertakking-voorspelling-TKA kry elke verkeerde voorspelling ’n vaste wagtydstraf. Hoeveel ekstra siklusse kos een verkeerde voorspelling? Skryf net die getal.", answer: "3", explanation: "Elke fout kos 3 siklusse. Daarom: totale straf = aantal foute × 3; by vier foute is dit 4 × 3 = 12 siklusse.", hint: "Lees die koste per fout in die vertakking-voorbeeld, nie die totale straf nie." },
    { prompt: "’n Superskalêre verwerker wil twee instruksies gelyk begin. Hulle is reeds onafhanklik. Watter tweede voorwaarde moet waar wees voordat hulle parallel kan uitvoer? Skryf die volledige term.", answer: "verskillende uitvoeringseenhede", explanation: "Onafhanklike instruksies kan net gelyk uitvoer wanneer geskikte, verskillende uitvoeringseenhede beskikbaar is—byvoorbeeld LSE vir ’n laai en VVE vir imul.", hint: "Vergelyk die rolle van LSE, RLE en VVE in die Superskala-antwoord." },
  ],
};

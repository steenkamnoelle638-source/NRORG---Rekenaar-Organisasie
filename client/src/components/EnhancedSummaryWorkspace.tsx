/**
 * Ingenieurswerkboek-rigting: hierdie uitgebreide opsommingslaag groepeer
 * hoof-, sub- en subsubonderwerpe soos in die gebruiker se klasnotas. Dit
 * gebruik kleur as ’n studie-sein, benoemde tabelle en konkrete werkpaaie.
 */
